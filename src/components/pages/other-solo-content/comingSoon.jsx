...
const ComingSoon = ({ showHeader = false }) => {
  ...
  // If showHeader is false, render the full-page version
  if (!showHeader) {
    return (
  ...
  // If showHeader is true, render the version with padding for header
  return (
    <div className="coming-soon-with-header">
      <div className="coming-soon-background-effect" />
