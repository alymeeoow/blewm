      ...
      <div className="vitamins-content">
        ...
        <section className="vitamins-section vitamins-intro">
          <div className="vitamins-container">
            ...
            <div className="vitamins-intro-content">
              <div className="vitamins-intro-text">
                ...
                <div className="vitamins-benefits-grid">
                  ...
                  <div className="vitamins-benefit">
                    <div className="vitamins-benefit-icon">
                      <img 
                        src="https://images.unsplash.com/photo-1551076805-e1869033e561?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80"
                        alt="Mental Clarity" 
                        onError={(e) => {
                          e.target.onerror = null;
                  ...
                  <div className="vitamins-benefit">
                    <div className="vitamins-benefit-icon">
                      <img 
                        src="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80"
                        alt="Better Recovery" 
                        onError={(e) => {
                          e.target.onerror = null;
              ...
              <div className="vitamins-intro-image">
                <img 
                  src="https://images.unsplash.com/photo-1551076805-e1869033e561?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
                  alt="Direct Vitamin Injection Therapy"
                  className="vitamins-intro-img"
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src = 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80';
                  }}
                />
              </div>
            </div>
          ...
          <div className="vitamins-container">
            ...
            <div className="vitamins-product-card">
              ...
              <div className="vitamins-product-details">
                ...
                >
                  <span className="vitamins-btn-text">Start Your Journey</span>
