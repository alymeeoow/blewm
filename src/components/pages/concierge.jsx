...
import LabResult from "../../assets/images/concierge/lab-result.png"
import DocCheck from "../../assets/images/concierge/doc-check.png"
import SameTime from "../../assets/images/concierge/same-time.png"

import WeightLossResult from "../../assets/images/concierge/r-d.png"
import EnergyBoostResult from "../../assets/images/concierge/c-m.png"
import HeartHealthResult from "../../assets/images/concierge/r-g.png"
import PreventativeResult from "../../assets/images/concierge/a-v.png"
...
const ConciergePage = () => {
  ...
  return (
    <div className="concierge-page">
        ...
        <div className="concierge-container">
          ...
          <div className="concierge-pricing-cards">
            <div className="concierge-pricing-card">
              ...
              <button 
                className="concierge-btn concierge-btn-secondary"
            ...
            <div className="concierge-pricing-card concierge-pricing-card-featured">
              ...
              <button 
                className="concierge-btn concierge-btn-primary"
                onClick={handleSubscribe}
              >
                Choose Annual
              </button>
      ...
      {/* Results Section - UPDATED WITH IMAGES */}
